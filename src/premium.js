// src/premium.js
// The paywall check. Returns the members-only tool data (use cases + locked
// links) ONLY to a visitor who is logged in AND holds an active paid plan.
// Everyone else is turned away. This is what makes the paywall real.
//
...
//
// Settings it needs (set these on the Worker, see deploy notes):
...
export async function handlePremium(request, env) {
